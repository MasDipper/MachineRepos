...
def fun_tokenize(text: str) -> str:
    ...
    russian_stopwords.extend(['т.д.', 'т', 'д', 'это','который','с','своём','всем','наш', 'свой', 'также', 'которые',
                              '–', 'очень', 'нужно', 'просто', 'например', 'всё', 'поэтому', 'который', 'какие',
                              'такой',
                              'другой', 'каждый', 'свой', 'должный', 'быть', 'тот', 'сам', 'свой', 'мой', 'тот', 'кто',
                              'ваш', 'мы', 'какой', 'простой', 'либо', 'самый', 'ещё', 'любой', 'несколько',
                              'некоторый', 'должный', 'являться', 'новый', 'свой', 'этот', 'разный', 'самый'])
